...
button#btn {
	...
	$("document").ready(function(){
		 ...
		 $("button#btnReply").click(function(){ 
	        ...
	        $("input#qna_num").prop("disabled", false);
	        $("input#qna_id").prop("disabled", false);
	        
	        var frm = document.replyFrm;
	        frm.action="qna_reply.go";
	        frm.method="POST";
	        frm.submit();
 ...
 <tbody>
		    <tr>
			      ...
			      <td style="text-align: left;">
				      <input type="text" id="qna_num" name="qna_num" value="글번호" disabled="disabled"/>
			      </td> 
			   </tr>
		    <hr>
			   <tr>
			      ...
			      <td style="text-align: left;">
				      <input type="text" id="qna_id" name="qna_id" value="아이디" disabled="disabled"/>&nbsp;&nbsp;
			   ...
			   <tr>
			      ...
			      <td style="text-align: left;">
			         <input type="text" id="qna_subject" name="qna_subject" maxlength="100"  style="width:50%" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; RE : 답글입니다." autofocus required />
			      </td>
			   </tr>
