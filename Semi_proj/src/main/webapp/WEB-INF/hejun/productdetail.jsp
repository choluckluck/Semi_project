...
<div id="container" style=" margin:0 auto; width:90%;">
	...
	<div class="row">	
		<div class="col-4" style="">
		   <img src="https://www.jinnykimcollection.co.kr/web/product/extra/small/202208/a71ea7169a3030bfdf98fce73d65ee6f.jpg"  style="margin: 0 auto; width:450px; height:550px; position:relative;" alt="...">
		   <br><br>
		   
		   <div style="border:margin: 0 auto; text-align:left;">
		      <img src="./images/1.jpg" class="" alt="..." style="width:18%; margin:10px 10px;">
		      <img src="./images/2.jpg" class="" alt="..." style="width:18%; margin:10px 10px;">
		      <img src="./images/3.jpg" class="" alt="..." style="width:18%; margin:10px 10px;">
		      <img src="./images/3.jpg" class="" alt="..." style="width:18%; margin:10px 10px;">
		      <img src="./images/3.jpg" class="" alt="..." style="width:18%; margin:10px 10px;">
		   </div>
		</div>
