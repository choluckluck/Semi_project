...
<div class="container">
	...
	<div>
		<p class="fst-normal" style="text-align: left; font-size: 25px; padding-bottom: 30px;">NEW</p>
	</div>
  		...
  		<div class="card" style="width: 16rem;">
  			<img src="<%= ctxPath%>/images/jihee/card.png" class="card-img-top" alt="...">
  				<div class="card-body">
    				...
    				<a href="<%= request.getContextPath()%>/jihee/product/productBest.up"class="btn btn-outline-primary">BEST</a>
  				</div>
		</div>
     </div>
