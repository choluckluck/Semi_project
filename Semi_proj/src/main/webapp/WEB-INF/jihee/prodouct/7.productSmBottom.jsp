...
<div class="container">
	...
	<div>
		<p class="fw-bolder" style="text-align: left; font-size: 25px; padding-bottom: 30px;">슬링백/뮬</p>
	</div>
  		...
  		<div class="card" style="width: 16rem;">
  			<img src="<%= ctxPath%>/images/jihee/card.png" class="card-img-top" alt="...">
  				<div class="card-body">
    				...
    				<a href="<%= request.getContextPath()%>/jihee/product/productHp.sue"class="btn btn-outline-primary" style="color:blue;">상세페이지</a>
  				</div>
		</div>
     </div>
