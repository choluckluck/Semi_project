	  ...
	  <div class="row">
		 <div class="col-md-2" id="sideinfo">
			...
			<div id="sidecontent" style="text-align: left; padding: 20px;">
						<div class="row">
				<div class="col ">
				<p class="fw-bolder" style="font-size: 30px">슬링백/뮬</p>
				</div>
			</div>
				<ul style="list-style: none; text-align: left; padding:0px; font-size: 17px; color:gray;">
					<li class="fw-bolder"> <a href="<%=ctxPath%>/jihee/product/productSlingback.sue" class="link" style="text-decoration: none; color: black;">슬링백 1cm~4cm</a><li>
					<li class="fw-bolder"><a href="<%=ctxPath%>/jihee/product/productMule.sue" class="link" style="text-decoration: none; color: gray;">뮬 6cm~</a><li>
		 ...
		 <div class="col-md-10" id="maininfo" align="center"> 
			...
			<div id="maincontent">
		 <jsp:include page="7.productSmTop.jsp" /> 
		 <jsp:include page="7.productSmBottom.jsp" />
		</div>
	 </div>
	 </div>
</div> 
...
<script type="text/javascript">
	...
	function goSearch() {
		...
		frm.action = "productSlingback.sue";
		frm.submit();
