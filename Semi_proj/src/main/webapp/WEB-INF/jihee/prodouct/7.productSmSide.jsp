		 ...
		 <div class="col-md-2" id="sideinfo">
			...
			<div id="sidecontent" style="text-align: left; padding: 20px;">
				...
				<ul style="list-style: none; text-align: left; padding:0px; font-size: 17px; color:gray;">
					<li class="fw-bolder"> <a href="#" class="link">슬링백 1cm~3cm</a><li>
					<li class="fw-bolder"><a href="#" class="link">슬링백 4cm~</a><li>
					<li class="fw-bolder"><a href="#" class="link">뮬 1cm~3cm</a><li>
					<li class="fw-bolder"><a href="#" class="link">뮬4cm~</a><li>				
				</ul>
				<br>
			<div class="row">
				<div>
