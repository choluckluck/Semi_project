		 ...
		 <div class="col-md-2" id="sideinfo">
			...
			<div id="sidecontent" style="text-align: left; padding: 20px;">
				...
				<ul style="list-style: none; text-align: left; padding:0px; font-size: 17px; color:gray;">
					<li class="fw-bolder"> <a href="<%=ctxPath%>/jihee/product/productAnkle4cm.sue" class="link" style="text-decoration: none; color: black;">앵클 1~6cm</a><li>
...
<script type="text/javascript">
	...
	function goSearch() {
		...
		frm.action = "productAnkle4cm.sue";
		frm.submit();
