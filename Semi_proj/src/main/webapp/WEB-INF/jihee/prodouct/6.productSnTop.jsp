...
<div class="container">
	...
	<div >
		<img src="<%= ctxPath%>/images/jihee/snproduct.png" class="img-fluid col-lg-12" alt="..." style="padding-bottom: 30px;">
	</div>
  		...
  		<div class="card" style="width: 16rem;">
  			<img src="<%= ctxPath%>/images/jihee/card.png" class="card-img-top" alt="...">
  				<div class="card-body">
    				...
    				<a href="<%= request.getContextPath()%>/jihee/product/productNew.sue"class="btn btn-outline-primary" style="color:blue;">슬링백/뮬</a>
  				</div>
		</div>
     </div>
