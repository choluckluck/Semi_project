		 ...
		 <div class="col-md-2" id="sideinfo">
			...
			<div id="sidecontent" style="text-align: left; padding: 20px;">
				...
				<ul style="list-style: none; text-align: left; padding:0px; font-size: 17px; color:gray;">
					<li class="fw-bolder"> <a href="#" class="link">캔버스</a><li>
					<li class="fw-bolder"><a href="#" class="link">골프화</a><li>
					<li class="fw-bolder"><a href="#" class="link">어글리 스니커즈</a><li>
					<li class="fw-bolder"><a href="#" class="link">스니커즈</a><li>				
				</ul>
				<br>
			<div class="row">
				<div>
