...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			});// 아이디가 qna_content 인 것은 포커스를 잃어버렸을 경우(blur) 이벤트를 처리해주는 것이다.
...
<tbody>
  ...
  <th scope="row">제목&nbsp</th>
    <select id="optionselect" style="width: auto; font-size:15px;">
                   <option selected value="0" style="width: 4000px;">(특가)드레이로퍼</option>
                    </select>
  </tr>
  </tbody>
  
  <hr>
  <th scope="row">평점&nbsp</th>
...
<div class="form-check form-check-inline">
  ...
  <form class="form-inline">
    <label for="UCC">UCC URL&nbsp&nbsp</label>
    <input type="text" class="form-control" id="UCC" >
</form>
...
<hr>
<th scope="row">비밀글설정&nbsp&nbsp</th>
