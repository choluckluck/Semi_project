...
public class GoogleMail {
	public void sendmail(String recipient, String certificationCode) throws Exception {
        ...
        prop.put("mail.smtp.user", "testhyerin25@gmail.com");
        ...
        // 보내는 사람의 메일주소
        String sender = "testhyerin25@gmail.com";
	...
	public void sendmail_OrderFinish(String recipient, String name, String emailContents) throws Exception {
		...
		// 제목 설정
		String subject = "감사합니다! " + name +"님의 주문이 성공하였습니다.";
		msg.setSubject(subject);
		...
		// 메시지 본문의 내용과 형식, 캐릭터 셋 설정
		msg.setContent("발송된 인증코드 : <span style='font-size:14pt; color:red;'>"+emailContents+"</span>", "text/html;charset=UTF-8");
		
		// 메일 발송하기
		Transport.send(msg);
	}//end of sendmail_OrderFinish
}
