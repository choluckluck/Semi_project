...
public class ProductSlingback extends AbstractController {
       ...
       */
		...
		while( !(loop > blockSize || pageNo > totalPage) ) { //loop가 blocksize보다 커지면 탈출
			if(pageNo == Integer.parseInt(currentShowPageNo)) {
				...
				pageBar += "<li class='page-item'><a class='page-link' href='productSlingback.sue?sizePerPage="+sizePerPage+"&currentShowPageNo="+pageNo+"&searchWord="+searchWord+"&searchPrice1="+searchPrice1+"&searchPrice2="+searchPrice2+"&selectItem="+selectItem+"'>" + pageNo + "</a></li>";
			}
		...
		super.setViewPage("/WEB-INF/jihee/prodouct/7.productSlingback.jsp");
