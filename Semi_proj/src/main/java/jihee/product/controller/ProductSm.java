...
public class ProductSm extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//1-1 종류 넘겨주기
				...
				String productType_1 = "slingback";
				paraMap.put("productType_1", productType_1);
				
				String productType_2 = "mule";
				...
				String productHigh_1 ="6.5";
				
				paraMap.put("productHigh_1", productHigh_1);
				
				String productHigh_2 ="3.5";
       ...
       */
		...
		while( !(loop > blockSize || pageNo > totalPage) ) { //loop가 blocksize보다 커지면 탈출
			if(pageNo == Integer.parseInt(currentShowPageNo)) {
				...
				pageBar += "<li class='page-item'><a class='page-link' href='productSm.sue?sizePerPage="+sizePerPage+"&currentShowPageNo="+pageNo+"&searchWord="+searchWord+"&searchPrice1="+searchPrice1+"&searchPrice2="+searchPrice2+"&selectItem="+selectItem+"'>" + pageNo + "</a></li>";
			}
		...
		super.setViewPage("/WEB-INF/jihee/prodouct/7.productSmSide.jsp");
