...
public class ProductBest extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//1-1 종류 넘겨주기
				...
				String productType_3 = "slingback";
       ...
       */
		...
		while( !(loop > blockSize || pageNo > totalPage) ) { //loop가 blocksize보다 커지면 탈출
			if(pageNo == Integer.parseInt(currentShowPageNo)) {
				...
				pageBar += "<li class='page-item'><a class='page-link' href='productBest.sue?sizePerPage="+sizePerPage+"&currentShowPageNo="+pageNo+"&searchWord="+searchWord+"&searchPrice1="+searchPrice1+"&searchPrice2="+searchPrice2+"&selectItem="+selectItem+"'>" + pageNo + "</a></li>";
			}
		...
		super.setViewPage("/WEB-INF/jihee/prodouct/2.productBestSide.jsp");
