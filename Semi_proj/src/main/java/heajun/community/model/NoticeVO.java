...
public class NoticeVO {
	...
	private String notice_registerday;		// 공지사항 글 작성일
	...
	public NoticeVO(int notice_code, String fk_userid, String notice_subject, String notice_contents, int notice_count,
			String notice_registerday, String notice_file_1, String notice_file_2, String notice_file_3) {
	...
	public String getNotice_registerday() {
		return notice_registerday;
	}
	public void setNotice_registerday(String notice_registerday) {
		this.notice_registerday = notice_registerday;
	}
