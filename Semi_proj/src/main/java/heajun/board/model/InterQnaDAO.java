...
public interface InterQnaDAO {
	...
	QnaVO_HJ qnaOneDetail(String qna_code) throws Exception;
	...
	// 수정한 글 보여주기
	QnaVO_HJ updateEnd(String fk_member_code, String category, String subject, String contents, String qna_code,
	...
	List<QnaVO_HJ> selectPagingQnaList(Map<String, String> paraMap)throws Exception;
