...
<br><br>
### 상품목록
- 상품 목록 조회(카테고리 별 BEST 상품, 일반 상품,할인상품 등)
- 필터 기능[검색어,가격,색상,사이즈,상품정렬(인기상품순,신상품순,낮은가격순,높은가격순)]
![슈샵 메인](https://user-images.githubusercontent.com/110098108/210310008-5dba836a-7ed1-4cf9-a12f-c190c0adbd1d.jpg)

<br><br>
### 장바구니
- 주문(개별주문,선택주문,전체주문),삭제
- 옵션 변경(색상,사이즈 변경),수량 변경
- 상품 추천
- 퀵뷰 기능(전체 페이지에서 가능) - 관심상품 개수,관심상품으로 이동, 스크롤 최상단/최하단 이동
![슈샵장바구니](https://user-images.githubusercontent.com/110098108/210310070-f3802600-dce2-4b69-b0ac-763af47e370f.jpg)
